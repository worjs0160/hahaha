            ...
            ">
                ...
                ">
                    ...
                    <div class="manage-val3-header" style="display:flex; align-items:center; justify-content:space-between;">
                        <h1 class="pre-400">일정 등록하기</h1>
                        <button @click="dialogCoverSet(false), (scheduleAddDialogStateChange(false))">
                    ...
                    <div style="padding:24px;">
                        ...
                        <div class="work-update-row4-1 mt-5">
                            <h2 style="
                            font-size: 15px;
                            color: #989898;
                            ...
                            <div class="timeinputBox">
                                ...
                                <v-text-field
                                v-model="scheduleAddDialogData.start"
                                label=""
                                type="datetime-local"
                                hide-details="auto"
                                ...
                                <v-text-field
                                v-model="scheduleAddDialogData.end"
                                label=""
                                type="datetime-local"
                                hide-details="auto"
                        ...
                        <v-col class="jin123 px-2 p-1" cols="12">
                            ...
                            font-weight: 400;
                            ">제목</h2>
                            <input type="text" v-model="scheduleAddDialogData.title" style="
                            background: #F5F5F5;
                            border-radius: 6px;
                            padding: 10px;
                            width: 100%;
                        ...
                        <v-col class="jin1234 px-2" cols="12">
                            ...
                            font-weight: 400;
                            ">내용</h2>
                            <textarea name="" id="" cols="30" rows="5" v-model="scheduleAddDialogData.contents" style="
                            background: #F5F5F5;
                            border-radius: 6px;
                            padding: 10px;
                            width: 100%;
                        ...
                        <div class="btnBox22">
                            <v-btn style="color: #49ADA9 !important; background: #EFF9F8 !important;" class="pre-400" @click="dialogCoverSet(false), (scheduleAddDialogStateChange(false)), (scheduleAddData(scheduleAddDialogData))">저장</v-btn>
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        ...
        scheduleAddDialogStateChange(val){
            this.$emit("scheduleAddDialogStateChange", val);
        },
        scheduleAddData(val){
            this.$emit("scheduleAddData", val);
        }
    }
};
</script>
