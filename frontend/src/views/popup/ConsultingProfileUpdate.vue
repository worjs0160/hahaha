      ...
      <div class="manage-val3-wrap" style="
          ...
          <div class="val3Box1 val3Box2" style="padding: 32px 24px;">
            ...
            <div class="careerBox defaultBox">
              ...
              <div class="val3-inputBox">
                <h3>수상경력</h3>
                <textarea name="" id="" cols="50" rows="5" v-model="data.awards" style="
                  border-radius: 3px;
          ...
          <div class="val3Box1 val3Box3" style="padding: 24px 24px 32px;">
...
export default {
  ...
  methods: {
    ...
    scrollTop(){
      document.getElementById('consultingProfileUpdate').scrollTo(0,0)
    },
    preview_image() {
    ...
    async settingAccount(id){
      ...
      await this.$axios
        ...
        .then((res) => {
          ...
          this.selectStateUpdate(res.data)
      });
      await this.$axios
        .get("consultings/api/image/"+id+"/")
        .then((res) => {
    ...
    async signup() {
      ...
      await this.$axios({
          method: "PATCH",
          url: "consultings/api/player/"+this.data.id+"/",
          data: this.data,
        })
        .then(() => {
          this.updateProfile()
      ...
      if(this.imageFlag == true){//이미지 수정했을때만 실행
        ...
        await this.$axios({
          method: "PATCH",
          url: "consultings/api/image/" + this.data.id + "/",
          headers: {
