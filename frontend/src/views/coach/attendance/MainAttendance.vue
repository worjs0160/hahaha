...
<script>
import UserList from "/src/views/coach/attendance/UserList";
import ManageAttendance from "/src/views/coach/attendance/ManageAttendance";
import SearchBarHeader from "/src/views/coach/attendance/SearchBarHeader";
